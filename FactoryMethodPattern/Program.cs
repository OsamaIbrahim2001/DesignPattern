...
using FactoryMethodPattern.ShoppingCart;
...
while (true)
{
    ...
    Console.WriteLine("Select Payment Method (Vissa | Paypal): ");
     PaymentProcess paymentProcess = Console.ReadLine().Equals("Vissa", StringComparison.OrdinalIgnoreCase) ? new VissaPaymentProcess() : new PaypalPaymentProcess();

    shoppingCart.Checkout(customer, paymentProcess);
